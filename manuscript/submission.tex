...
In the 2020 Summer Olympic games in Tokyo, the United States women's artistic gymnastics team was the only team to take 
...
Currently there is no literature available relevant to predicting gymnastics outcomes at the Olympics, 
but there is literature that relates to various aspects of 
...
As existing literature fails to suggest how data from major gymnastics competitions 
can be used to identify the ``best'' Olympic team candidates, 
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
     ...
     deviation to identify which athletes are best suited to be considered to compete on behalf of the USA on each apparatus.
     \begin{enumerate}
...
Looking at the plot of the combinations of four athletes, it is not clear whether Chiles, Carey, or 
...
as the fifth USA team member who does not compete in the all-around qualifying round. Additionally, 
...
athletes on vault, it is reasonable to select her to be the final member of the Olympic team. 
...
outlines a procedure for identifying the USA Olympic Women’s Artistic Gymnastics team that will optimize 
...
to the 2024 Olympics was very similar, but varied when it came to determining the fifth team member. After 
